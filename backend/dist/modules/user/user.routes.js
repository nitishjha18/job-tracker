...
router.post("/resume", auth_1.requireUser, user_controller_2.uploadMiddleware, user_controller_2.uploadResumeController);
router.put("/profile", auth_1.requireUser, user_controller_3.updateProfileController);
